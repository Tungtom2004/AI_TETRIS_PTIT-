...
class TetrisInterface(abc.ABC):
    ...
    def reset(self, avatar1_path=None, avatar2_path=None, name1=None, name2=None, fontsize=40):
        ...
        for i, player in enumerate(self.tetris_list):
            ...
            com_event.reset()
            self.renderer.drawByName("gamescreen", pos["gamescreen"][0],
                                     pos["gamescreen"][1])  # blitting the main background

            self.renderer.drawGameScreen(tetris)

        self.renderer.drawAvatar(img_path1=avatar1_path, img_path2=avatar2_path, name1=name1, name2=name2,
                                 fontsize=fontsize)
